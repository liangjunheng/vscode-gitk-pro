...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  #commitToggleBtn .codicon { font-size: 11px; line-height: 1; }
  #commitToggleBtn.amend { background: color-mix(in srgb, var(--vscode-button-foreground) 22%, transparent); }
